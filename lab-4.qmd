...
#use dropdown menu for selection of yes/no science questions
```
...
selectInput('valuecard1', label = 'Valuecard 1', 
            choice = c('Percentage', 'Proportion'),
            multiple = FALSE, selected = 'Percentage') 
...
output$myvaluebox <- renderUI({
  
  if (input$valuecard1 == "Percentage")
    v = value_box(theme_color = "success",
      title = "Want To Learn More About Science",
      value = paste(round(want_to_know_more_science * 100,2), '%'),
      showcase_layout = showcase_top_right(max_height = "100px"))
    
 
  
  if (input$valuecard1 == "Proportion")
    v = value_box(theme_color = "success",
      title = "Want To Learn More About Science",
      value = round(want_to_know_more_science,4),
      showcase_layout = showcase_top_right(max_height = "100px"))
